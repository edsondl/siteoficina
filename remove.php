...
<title>Menu que seleciona o que remover</title>
<?php
...
<div id="itens">
  ...
  <div id="itens">	
   ...
   <div id="itens">
           ...
           <form action="rec_remove.php" method="post" enctype="multipart/form-data">
           <table><tr>
           ...
           <tr>
          <td>Código do Produto:</td><td> <input type="text" name="codigo" size="5px"></td>
          </tr>
          <tr><td><input type="submit" value="Deletar">
          </td></tr>
