...
<title>Seleciona acessórios</title>
...
<div id="itens">
  ...
  <div id="itens">	
   ...
   <div id="itens">
		...
		$resultado = mysql_query("SELECT * FROM acessorios"); //seleciona todos acessórios
				...
				<a href='projeto7a.php'>
					<div id='titu'> $reg[1]</div>
						...
						<div id='interna2'>
							...
							<a href='projeto7a.php'><img src='imagens/detalhes.png'></a>
							</div>
                 	</div>
					</li>
				 ";
