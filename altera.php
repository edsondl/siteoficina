...
<title>Página inicial para alterar produtos</title>
<?php
...
<div id="itens">
  ...
  <div id="itens">	
		...
		<li><a href="projeto4a.php" alt="Home" title="Clique aqui e entre em contato conosco!!!"><img src="imagens/CONTATO.png"></a></li>
   ...
   <div id="itens">
           ...
           <form action="rec_altera.php" method="post" enctype="multipart/form-data">
           <table><tr>
           ...
           <tr>
           <td>Escolha o campo:</td>
           <td><select name="tabela2">
           ...
           <tr>
          <td>Novo Valor</td><td> <input type="text" name="new" size="50px"></td>
          </tr>
